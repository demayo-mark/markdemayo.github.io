...
## About
I’m a hardware-focused engineering professional with hands-on experience in **high-voltage battery testing**, **test execution**, **debugging**, and **data-driven validation**. I build practical systems end-to-end—from requirements and schematics to bring-up, measurement, and documentation.
